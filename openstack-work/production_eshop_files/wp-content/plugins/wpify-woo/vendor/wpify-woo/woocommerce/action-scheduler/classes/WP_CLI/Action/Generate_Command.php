...
class Generate_Command extends \ActionScheduler_WPCLI_Command
{
    ...
    public function execute()
    {
        ...
        $interval = (int) get_flag_value($this->assoc_args, 'interval', 0);
        // avoid absint() to support negative intervals
        ...
        $function_args = array('start' => absint($schedule_start->format('U')), 'interval' => $interval, 'count' => $count, 'hook' => $hook, 'callback_args' => $callback_args, 'group' => $group);
