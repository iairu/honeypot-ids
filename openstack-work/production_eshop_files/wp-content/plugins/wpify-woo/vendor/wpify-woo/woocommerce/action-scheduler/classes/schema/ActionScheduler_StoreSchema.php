...
class ActionScheduler_StoreSchema extends \ActionScheduler_Abstract_Schema
{
    ...
    {
        $this->tables = array(self::ACTIONS_TABLE, self::CLAIMS_TABLE, self::GROUPS_TABLE);
    }
    /**
    ...
    protected function get_table_definition($table)
    {
        ...
        $hook_status_scheduled_date_gmt_max_index_length = $max_index_length - 20 - 8;
 ...
 * Creates custom tables for storing scheduled actions
 */
\class_alias('WpifyWooDeps\ActionScheduler_StoreSchema', 'ActionScheduler_StoreSchema', \false);
