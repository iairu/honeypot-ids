...
abstract class ActionScheduler
{
    ...
    public static function plugin_path($path)
    {
        ...
        if ($path) {
            return \trailingslashit($base) . $path;
        } else {
    ...
    {
        static $abstracts = array('ActionScheduler' => \true, 'ActionScheduler_Abstract_ListTable' => \true, 'ActionScheduler_Abstract_QueueRunner' => \true, 'ActionScheduler_Abstract_Schedule' => \true, 'ActionScheduler_Abstract_RecurringSchedule' => \true, 'ActionScheduler_Lock' => \true, 'ActionScheduler_Logger' => \true, 'ActionScheduler_Abstract_Schema' => \true, 'ActionScheduler_Store' => \true, 'ActionScheduler_TimezoneHelper' => \true, 'ActionScheduler_WPCLI_Command' => \true);
    ...
    {
        static $cli_segments = array('QueueRunner' => \true, 'Command' => \true, 'ProgressBar' => \true, '\Action_Scheduler\WP_CLI\Action_Command' => \true, '\Action_Scheduler\WP_CLI\System_Command' => \true);
        $segments = \explode('_', $class);
        $segment = isset($segments[1]) ? $segments[1] : $class;
 ...
 * @codeCoverageIgnore
 */
\class_alias('WpifyWooDeps\ActionScheduler', 'ActionScheduler', \false);
