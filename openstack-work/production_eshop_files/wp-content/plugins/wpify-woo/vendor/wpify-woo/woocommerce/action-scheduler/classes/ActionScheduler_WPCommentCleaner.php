...
class ActionScheduler_WPCommentCleaner
{
    ...
    {
        $has_logs = 'no';
        $args = array('type' => \ActionScheduler_wpCommentLogger::TYPE, 'number' => 1, 'fields' => 'ids');
        ...
        \update_option(self::$has_logs_option_key, $has_logs, \true);
    }
    /**
    ...
    public static function delete_all_action_comments()
    {
        ...
        \update_option(self::$has_logs_option_key, 'no', \true);
    }
    /**
 ...
 * @since 3.0.0
 */
\class_alias('WpifyWooDeps\ActionScheduler_WPCommentCleaner', 'ActionScheduler_WPCommentCleaner', \false);
