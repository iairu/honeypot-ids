...
namespace WpifyWooDeps\rikudou\EuQrPayment\Tests\Iban\Validator;

use InvalidArgumentException;
use WpifyWooDeps\PHPUnit\Framework\TestCase;
use WpifyWooDeps\rikudou\EuQrPayment\Iban\IBAN;
use WpifyWooDeps\rikudou\EuQrPayment\Iban\Validator\CompoundValidator;
use WpifyWooDeps\rikudou\EuQrPayment\Iban\Validator\CzechIbanValidator;
...
class CompoundValidatorTest extends TestCase
{
    ...
    {
        new CompoundValidator(new GenericIbanValidator(new IBAN('')), new CzechIbanValidator('123', '123'));
    }
    ...
    public function testIsValid()
    {
        ...
        $valid4 = new CompoundValidator($this->validGenericValidator(), $this->validCzechValidator(), $this->validFakeValidator());
        ...
        $invalid4 = new CompoundValidator($this->invalidGenericValidator(), $this->invalidCzechValidator(), $this->invalidFakeValidator());
        $mixed1 = new CompoundValidator($this->validGenericValidator(), $this->invalidFakeValidator());
        $mixed2 = new CompoundValidator($this->validFakeValidator(), $this->validGenericValidator(), $this->validCzechValidator(), $this->invalidFakeValidator(), $this->invalidCzechValidator(), $this->invalidGenericValidator());
        ...
        $mixed3 = new CompoundValidator($this->invalidFakeValidator(), $this->fakeValidatorThatThrowsException());
