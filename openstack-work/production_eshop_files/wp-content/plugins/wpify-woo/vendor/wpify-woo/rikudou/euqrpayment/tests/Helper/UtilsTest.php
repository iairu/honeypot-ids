...
namespace WpifyWooDeps\rikudou\EuQrPayment\Tests\Helper;
...
use WpifyWooDeps\rikudou\EuQrPayment\Tests\Data\ConstantsClass;
use stdClass;
class UtilsTest extends TestCase
{
    public function testGetConstants()
    {
        ...
        $this->assertEquals(['NAME1' => 'value1', 'NAME2' => 'value2'], Utils::getConstants(ConstantsClass::class));
    ...
    public function testGetType()
    {
        ...
        $this->assertEquals("WpifyWooDeps\\rikudou\\EuQrPayment\\Iban\\IBAN", Utils::getType($class2));
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        Utils::bcmod(1, '87289320019831928372193981274715795247', \true);
    }
