...
class GutenbergBlock extends BaseIntegration
{
    ...
    {
        $args = array(...$this->get_args(), 'variation_callback' => $this->variation_callback, 'editor_script_handles' => $this->editor_script_handles, 'script_handles' => $this->script_handles, 'view_script_handles' => $this->view_script_handles, 'editor_style_handles' => $this->editor_style_handles, 'style_handles' => $this->style_handles, 'view_style_handles' => $this->view_style_handles);
    ...
    {
        $args = array('api_version' => $this->api_version, 'title' => $this->title, 'category' => $this->category, 'parent' => $this->parent, 'ancestor' => $this->ancestor, 'allowed_blocks' => $this->allowed_blocks, 'icon' => $this->icon, 'description' => $this->description, 'keywords' => $this->keywords, 'textdomain' => $this->textdomain, 'styles' => $this->styles, 'variations' => $this->variations, 'selectors' => $this->selectors, 'supports' => $this->supports, 'example' => $this->example, 'attributes' => $this->attributes, 'uses_context' => $this->uses_context, 'provides_context' => $this->provides_context, 'block_hooks' => $this->block_hooks);
    ...
    public function render_from_api(\WP_REST_Request $request): string
    {
        ...
        $parsed_block = array('blockName' => $this->name, 'attrs' => $attributes, 'innerBlocks' => array(), 'innerHTML' => '', 'innerContent' => array());
