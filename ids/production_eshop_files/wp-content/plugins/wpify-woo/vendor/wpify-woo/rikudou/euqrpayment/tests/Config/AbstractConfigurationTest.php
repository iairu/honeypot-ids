...
namespace WpifyWooDeps\rikudou\EuQrPayment\Tests\Config;

use DateTimeImmutable;
use DateTimeInterface;
use WpifyWooDeps\rikudou\EuQrPayment\Config\AbstractConfiguration;
use WpifyWooDeps\PHPUnit\Framework\TestCase;
use WpifyWooDeps\rikudou\EuQrPayment\Config\DueDateHandlerInterface;
...
class AbstractConfigurationTest extends TestCase
{
    ...
    {
        return (new QrPayment(new CzechIbanAdapter('1325090010', '3030'), $configuration))->setAmount(123.4567)->setBeneficiaryName('Random Dude');
    }
