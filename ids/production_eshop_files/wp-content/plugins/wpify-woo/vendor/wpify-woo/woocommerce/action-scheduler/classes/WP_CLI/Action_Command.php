...
class Action_Command extends \WP_CLI_Command
{
    ...
    public function cancel(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\Cancel_Command($args, $assoc_args);
        $command->execute();
    }
    /**
    ...
    public function create(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\Create_Command($args, $assoc_args);
        $command->execute();
    }
    /**
    ...
    public function delete(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\Delete_Command($args, $assoc_args);
        $command->execute();
    }
    /**
    ...
    public function generate(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\Generate_Command($args, $assoc_args);
        $command->execute();
    }
    /**
    ...
    public function get(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\Get_Command($args, $assoc_args);
        $command->execute();
    }
    /**
    ...
    public function subcommand_list(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\List_Command($args, $assoc_args);
        $command->execute();
    }
    /**
    ...
    public function logs(array $args)
    {
        ...
        \Action_Scheduler\WP_CLI\WP_CLI::runcommand($command);
    }
    /**
    ...
    public function next(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\Next_Command($args, $assoc_args);
        $command->execute();
    }
    /**
    ...
    public function run(array $args, array $assoc_args)
    {
        ...
        $command = new \Action_Scheduler\WP_CLI\Action\Run_Command($args, $assoc_args);
        $command->execute();
    }
}
