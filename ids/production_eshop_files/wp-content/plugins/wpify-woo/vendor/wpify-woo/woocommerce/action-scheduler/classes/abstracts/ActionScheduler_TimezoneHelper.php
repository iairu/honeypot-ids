        ...
        foreach (\timezone_abbreviations_list() as $abbr) {
            foreach ($abbr as $city) {
                if ((bool) \date('I') === (bool) $city['dst'] && $city['timezone_id'] && \intval($city['offset']) === $utc_offset) {
                    // phpcs:ignore WordPress.DateTime.RestrictedFunctions.date_date	 -- we are actually interested in the runtime timezone.
 ...
 * Class ActionScheduler_TimezoneHelper
 */
\class_alias('WpifyWooDeps\ActionScheduler_TimezoneHelper', 'ActionScheduler_TimezoneHelper', \false);
