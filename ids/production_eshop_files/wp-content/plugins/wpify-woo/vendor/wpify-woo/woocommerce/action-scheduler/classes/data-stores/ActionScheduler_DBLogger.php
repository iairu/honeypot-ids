...
class ActionScheduler_DBLogger extends \ActionScheduler_Logger
{
    ...
    public function log($action_id, $message, ?\DateTime $date = null)
    {
        ...
        global $wpdb;
        $wpdb->insert($wpdb->actionscheduler_logs, array('action_id' => $action_id, 'message' => $message, 'log_date_gmt' => $date_gmt, 'log_date_local' => $date_local), array('%d', '%s', '%s', '%s'));
 ...
 * @since 3.0.0
 */
\class_alias('WpifyWooDeps\ActionScheduler_DBLogger', 'ActionScheduler_DBLogger', \false);
