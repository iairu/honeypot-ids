...
class ActionScheduler_wpCommentLogger extends \ActionScheduler_Logger
{
    ...
    public function get_logs($action_id)
    {
        ...
        $comments = \get_comments(array('post_id' => $action_id, 'orderby' => 'comment_date_gmt', 'order' => 'ASC', 'type' => self::TYPE, 'status' => $status));
    ...
    public function filter_comment_queries($query)
    {
        ...
        $query->query_vars['action_log_filter'] = \true;
    ...
    public function init()
    {
        ...
        \add_action('wp_count_comments', array($this, 'filter_comment_count'), 20, 2);
 ...
 * Class ActionScheduler_wpCommentLogger
 */
\class_alias('WpifyWooDeps\ActionScheduler_wpCommentLogger', 'ActionScheduler_wpCommentLogger', \false);
