...
class JsonToDataTransformer
{
    ...
    private static function isAddressFilled(Data $data): bool
    {
        ...
        return $data->street !== null || $data->country !== null || $data->country_code !== null || $data->city !== null || $data->city_post !== null || $data->city_district !== null || $data->district !== null || $data->house_number !== null;
    }
    /**
