...
# backup_service's backups (ids/backups/{db,wp}/*.gz) from the
...
#
# Usage (run from ids/, or from anywhere -- it cd's to its own
# directory first):
...
cmd_list() {
    ...
    echo "WP file archives (ids/backups/wp/):"
